    ...
    $.fn.simpleTimeline = function(options, data) {		
		...
		// -------------------------------------------------------------------------------
			...
			$('.timeline-phase, .timeline-indicator-line').each(function() {
				//$(this).css({ height: adj_height });//original method
				
				//edited method
				$('#'+$(self).attr('id')+" .timeline-phase").css({ height: adj_height });
				$('#'+$(self).attr('id')+" .timeline-indicator-line").css({ height: adj_height });
				//console.log($(self).attr('id')+" "+adj_height);
			});
